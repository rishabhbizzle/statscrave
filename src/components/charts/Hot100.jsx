  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      <div className="text-[8px] sm:text-[10px] md:text-[15px] box max-w-[700px] p-2 md:p-6 my-10">
        ...
        <div className="p-[14px] md:p-5 bg-black w-full flex justify-center shadow-2xl">
          <table className=" bg-white w-full ">
            <tr>
              <th className="bg-black text-white text-left md:px-2">RANK</th>
              <th className="bg-black text-white text-left px-1 md:px-2">
                +/-
              </th>
              <th className="bg-black text-white text-left"></th>
              <th className="bg-black text-white text-left px-1 md:px-2 ">
                SONG
              </th>
              <th className="bg-black text-white text-left px-1 md:px-2">
            ...
            {songsList.map((song, i) => (
              <tr className="even:bg-white odd:bg-gray-100 text-black" key={i}>
                ...
                <td
                  className={
                    song.weeks_on_chart < 40 ? "px-2" : "bg-yellow-100 px-2"
                  }
                >
                  {song.weeks_on_chart}
                </td>
