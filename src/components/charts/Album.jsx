...
import Head from "@/assets/album.png";
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="text-[8px] sm:text-[10px] md:text-[15px] box max-w-[700px] p-2 md:p-6 my-10">
        ...
        <img className="items-center" src='/album.png' alt="ALBUM" />
        </div>
        <div className="bg-[#00427F] text-xs md:text-sm text-muted-foreground text-end pr-3">
          @StatsCrave
        </div>
        {/* <div className="hot">
        <img src={Hot} alt="" />
        </div> */}
        <div className="p-[14px] md:p-5 bg-[#00427F] w-full flex justify-center shadow-2xl">
          <table className=" bg-white w-full ">
            <tbody>
              <tr>
                <th className="bg-[#00427F] text-white text-left md:px-2">
                  RANK
                </th>
                <th className="bg-[#00427F] text-white text-left px-1 md:px-2">
                  +/-
                </th>
                <th className="bg-[#00427F] text-white text-left"></th>
                <th className="bg-[#00427F] text-white text-left px-1 md:px-2 ">
                  ALBUM
                </th>
                <th className="bg-[#00427F] text-white text-left px-1 md:px-2">
